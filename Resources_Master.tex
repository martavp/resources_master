...
\begin{itemize}
\item[a)]  Background and context: Why is this research interesting? Why should the reader care about this? 
...
Make sure that every figure has a caption, every axis has a title, and the font size in the figure is similar to that in the text. This \href{https://doi.org/10.1371/journal.pcbi.1003833}{paper} provides ten simple rules to create better scientific figures. The \href{https://www.ipcc.ch/site/assets/uploads/2019/04/IPCC-visual-style-guide.pdf}{IPCC Visual Style Guide} also includes a lot of good recommendations. \href{https://github.com/cxli233/FriendsDontLetFriends}{The FriendsDontLetFriends repository} includes a good list of common mistakes in data visualization to be avoided. 
